...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Skill Hub — Agent OS" },
      { name: "twitter:title", content: "Skill Hub — Agent OS" },
      { property: "og:description", content: "Production-grade meta-agent skill registry with 88 skills" },
      { name: "twitter:description", content: "Production-grade meta-agent skill registry with 88 skills" },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/hb4FQ2NfkDdULU7YveE5vtJNxOc2/social-images/social-1777905135708-orynero-main-logo.webp" },
